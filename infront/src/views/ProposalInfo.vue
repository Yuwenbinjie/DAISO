                ...
                >
                    <template slot-scope="scope">
                        ...
                        <div v-if="scope.row.state=='1'&&scope.row.info">
                            ...
                            <div>investors: {{scope.row.info.invest}}</div>
                            <div>metaEvidenceId: {{scope.row.info._metaEvidenceId}}</div>
                            <div>stopTime For ProjectPayFees: {{scope.row.info.stopTimeForProjectPayFees}}</div>
                        </div>
...
export default {
    ...
    data() {
        return {
            data:[
                {
                    state:1,
                    info:{stopTimeForProjectPayFees:''},
                },
                {
                    state:2,
                    info:{},
    ...
    methods: {
        ...
        async ajaxQuery(){
            ...
            this.data[0].info.stopTimeForProjectPayFees = this.formatDate(new bignumber(create[0].returnValues.reclaimedAt).plus(86400).toString());
